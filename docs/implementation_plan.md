...
- [ ] Refine the published guide locally with two reviewed owner-photo lightboxes, descriptive media-link syntax, OddArticulations-backed adipocere guidance, and a collapsed case-by-case maceration troubleshooting mini-guide. The refinement branch remains local until owner review; it does not authorize a push, PR, merge, deployment, or broader editorial scope.
