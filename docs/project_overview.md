...
| `/methodology` | Measurement reference; later broader data transparency | Implemented five-view diagram board, 21 exact definition rows, annotation previews/details, and semantic table; identification confidence, taxonomy, missing-data, coordinate, and update sections remain later scope |
